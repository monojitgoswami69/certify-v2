            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 pb-3 sm:pb-3.5 border-b border-[#E5DAC3]">
                ...
                <div>
                  ...
                  {detailedEventSummary && (
                    <div className="flex items-center gap-2 mt-1 text-xs font-medium text-slate-600 flex-wrap">
                      <span className="font-bold text-slate-900">{detailedEventSummary.certificateCount} records</span>
                      <span className="text-stone-300">·</span>
                      <span className="text-emerald-700 font-bold">{detailedEventSummary.activeCount} active</span>
                      <span className="text-stone-300">·</span>
                      <span className={detailedEventSummary.revokedCount > 0 ? "text-red-700 font-bold" : "text-stone-500 font-bold"}>
                        {detailedEventSummary.revokedCount} revoked
                      </span>
                      {detailedEventSummary.templateName && (
                        <>
                          <span className="text-stone-300">·</span>
                          <span className="text-stone-500">Template: {detailedEventSummary.templateName}</span>
                        </>
                      )}
                      <span className="text-stone-300">·</span>
              ...
              <div className="flex items-center gap-2 self-start sm:self-auto pl-7 sm:pl-0">
                ...
                >
                  ...
                  <span>{loadingStudio ? 'Opening...' : 'Add Records in Studio'}</span>
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2.5">
              <div className="relative flex-1 w-full sm:max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-8.5 pr-3 py-1.5 text-xs sm:text-sm bg-white border border-[#E5DAC3] rounded-lg text-slate-900 placeholder:text-stone-400 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all shadow-2xs"
                />
              </div>
                  ...
                  <table className="w-full text-xs border-collapse">
                    <thead>
                      <tr className="bg-[#FBF4E2] border-b-2 border-[#E5DAC3] text-[11px] sm:text-xs font-bold text-[#554633] uppercase tracking-wider">
                        ...
                        <th className="py-2.5 sm:py-3 px-3 text-right w-40">Certificate ID</th>
                        ...
                        <th className="py-2.5 sm:py-3 px-3 text-right w-36">Actions</th>
                      </tr>
                    </thead>
                          ...
                          >
                            ...
                            <td className="py-2 px-3 text-right font-mono text-xs">
                              <div className="inline-flex items-center justify-end gap-1">
                                <span className="text-stone-700 font-medium truncate max-w-[120px]" title={cert.id}>
                                  {cert.id.slice(0, 10)}...
                                </span>
                                <button
                                  onClick={() => handleCopyId(cert.id)}
                                  className="p-1 hover:bg-slate-100 rounded text-stone-500 hover:text-stone-900 transition-colors cursor-pointer"
                            ...
                            <td className="py-2 px-3 text-right whitespace-nowrap">
                              <div className="inline-flex items-center justify-end gap-2.5">
                                ...
                                {/* Public Verification Link (Text at the end) */}
                                <a
                                  href={`/verify/${cert.id}`}
                                  target="_blank"
                                  rel="noreferrer"
                                  className="text-xs font-semibold text-primary-700 hover:text-primary-800 hover:underline transition-colors cursor-pointer"
